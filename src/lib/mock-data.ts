...
export const competitions: Competition[] = [
    ...
    },
    {
        ...
        description: "Competição de entregas do mês de Maio.",
        metric: 'deliveries',
        participants: 'all',
